...
// normally; for an indexed shape pass false to prepare it flat shading if it is not ready -- that is, if there are any edges where the same vertices are indexed by 
